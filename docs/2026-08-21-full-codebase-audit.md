...
4. **Resolved on 2026-08-22: project routes previously ignored username authority.** Projects now use `/repos/:owner/:repo/projectsV2`, and the repository path controls read and write authority for every project, item, and field operation.
