defmodule OpenAgents.Compensation.PolicyReceipt do
  @moduledoc "Append-only operator-admitted compensation accounting policy; never payout authority."
  use Ecto.Schema
  ...
  schema "compensation_policy_receipts" do
