...
The marks remain the trademarks of their owners. They are used here only to
label the action that reaches that service — a GitHub mark on the control that
